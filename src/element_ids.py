...
class DouyinElementIds:
    ...
    # ========== 评论流程元素 ==========
    COMMENT_BUTTON = 'com.ss.android.ugc.aweme:id/em='        # 评论按钮 (点击打开评论区)
    COMMENT_COUNT_TEXT = 'com.ss.android.ugc.aweme:id/title'  # 评论数显示 (如: "62条评论")
    COMMENT_LIST_CONTAINER = 'com.ss.android.ugc.aweme:id/i8_'  # 评论列表容器 (可滑动获取评论)
    COMMENT_ITEM = 'com.ss.android.ugc.aweme:id/e7w'          # 单条评论内容 (包含评论文本、用户、时间等)
    ...
    # ========== 谷歌浏览器元素 ==========
    # 用于图像识别找到"打开"按钮
    # 使用模板图像: templates/dakaidouyin.png

    # ========== 应用包名 ==========
    DOUYIN_PACKAGE = 'com.ss.android.ugc.aweme'  # 抖音包名
    CHROME_PACKAGE = 'com.android.chrome'         # 谷歌浏览器包名
